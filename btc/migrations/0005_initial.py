...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'btc_userprofile', (
            ...
            ('okCoin2BTCE_ltc', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('BTCE2okCoin_ltc', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('okCoin2bitfinex_ltc', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('bitfinex2okCoin_ltc', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('btce2bitfinex_ltc', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('bitfinex2btce_ltc', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('okCoin2huobi_ltc', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('huobi2okCoin_ltc', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('okCoin2btcchina_ltc', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('btcchina2okCoin_ltc', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('huobi2btcchina_ltc', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('btcchina2huobi_ltc', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('huobi2bitfinex_ltc', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('bitfinex2huobi_ltc', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('bitfinex2btcchina_ltc', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('btcchina2bitfinex_ltc', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 9, 0, 0), blank=True)),
        ))
        ...
        db.create_table(u'btc_pricebuysell', (
            ...
            ('btcchina_buyprice', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('huobi_buyprice', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ...
            ('btcchina_buyprice_ltc', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('huobi_buyprice_ltc', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 9, 0, 0), blank=True)),
        ))
