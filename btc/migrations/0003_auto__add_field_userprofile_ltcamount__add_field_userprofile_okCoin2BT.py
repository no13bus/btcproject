...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Userprofile.ltcamount'
        db.add_column(u'btc_userprofile', 'ltcamount',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)

        # Adding field 'Userprofile.okCoin2BTCE_ltc'
        db.add_column(u'btc_userprofile', 'okCoin2BTCE_ltc',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)

        # Adding field 'Userprofile.BTCE2okCoin_ltc'
        db.add_column(u'btc_userprofile', 'BTCE2okCoin_ltc',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)

        # Adding field 'Userprofile.okCoin2bitfinex_ltc'
        db.add_column(u'btc_userprofile', 'okCoin2bitfinex_ltc',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)

        # Adding field 'Userprofile.bitfinex2okCoin_ltc'
        db.add_column(u'btc_userprofile', 'bitfinex2okCoin_ltc',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)

        # Adding field 'Userprofile.btce2bitfinex_ltc'
        db.add_column(u'btc_userprofile', 'btce2bitfinex_ltc',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)

        # Adding field 'Userprofile.bitfinex2btce_ltc'
        db.add_column(u'btc_userprofile', 'bitfinex2btce_ltc',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)

        # Adding field 'Userprofile.okCoin2huobi_ltc'
        db.add_column(u'btc_userprofile', 'okCoin2huobi_ltc',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)

        # Adding field 'Userprofile.huobi2okCoin_ltc'
        db.add_column(u'btc_userprofile', 'huobi2okCoin_ltc',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)

        # Adding field 'Userprofile.okCoin2btcchina_ltc'
        db.add_column(u'btc_userprofile', 'okCoin2btcchina_ltc',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)

        # Adding field 'Userprofile.btcchina2okCoin_ltc'
        db.add_column(u'btc_userprofile', 'btcchina2okCoin_ltc',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)

        # Adding field 'Userprofile.huobi2btcchina_ltc'
        db.add_column(u'btc_userprofile', 'huobi2btcchina_ltc',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)

        # Adding field 'Userprofile.btcchina2huobi_ltc'
        db.add_column(u'btc_userprofile', 'btcchina2huobi_ltc',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)

        # Adding field 'Userprofile.huobi2bitfinex_ltc'
        db.add_column(u'btc_userprofile', 'huobi2bitfinex_ltc',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)

        # Adding field 'Userprofile.bitfinex2huobi_ltc'
        db.add_column(u'btc_userprofile', 'bitfinex2huobi_ltc',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)

        # Adding field 'Userprofile.bitfinex2btcchina_ltc'
        db.add_column(u'btc_userprofile', 'bitfinex2btcchina_ltc',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)

        # Adding field 'Userprofile.btcchina2bitfinex_ltc'
        db.add_column(u'btc_userprofile', 'btcchina2bitfinex_ltc',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Userprofile.ltcamount'
        db.delete_column(u'btc_userprofile', 'ltcamount')

        # Deleting field 'Userprofile.okCoin2BTCE_ltc'
        db.delete_column(u'btc_userprofile', 'okCoin2BTCE_ltc')

        # Deleting field 'Userprofile.BTCE2okCoin_ltc'
        db.delete_column(u'btc_userprofile', 'BTCE2okCoin_ltc')

        # Deleting field 'Userprofile.okCoin2bitfinex_ltc'
        db.delete_column(u'btc_userprofile', 'okCoin2bitfinex_ltc')

        # Deleting field 'Userprofile.bitfinex2okCoin_ltc'
        db.delete_column(u'btc_userprofile', 'bitfinex2okCoin_ltc')

        # Deleting field 'Userprofile.btce2bitfinex_ltc'
        db.delete_column(u'btc_userprofile', 'btce2bitfinex_ltc')

        # Deleting field 'Userprofile.bitfinex2btce_ltc'
        db.delete_column(u'btc_userprofile', 'bitfinex2btce_ltc')

        # Deleting field 'Userprofile.okCoin2huobi_ltc'
        db.delete_column(u'btc_userprofile', 'okCoin2huobi_ltc')

        # Deleting field 'Userprofile.huobi2okCoin_ltc'
        db.delete_column(u'btc_userprofile', 'huobi2okCoin_ltc')

        # Deleting field 'Userprofile.okCoin2btcchina_ltc'
        db.delete_column(u'btc_userprofile', 'okCoin2btcchina_ltc')

        # Deleting field 'Userprofile.btcchina2okCoin_ltc'
        db.delete_column(u'btc_userprofile', 'btcchina2okCoin_ltc')

        # Deleting field 'Userprofile.huobi2btcchina_ltc'
        db.delete_column(u'btc_userprofile', 'huobi2btcchina_ltc')

        # Deleting field 'Userprofile.btcchina2huobi_ltc'
        db.delete_column(u'btc_userprofile', 'btcchina2huobi_ltc')

        # Deleting field 'Userprofile.huobi2bitfinex_ltc'
        db.delete_column(u'btc_userprofile', 'huobi2bitfinex_ltc')

        # Deleting field 'Userprofile.bitfinex2huobi_ltc'
        db.delete_column(u'btc_userprofile', 'bitfinex2huobi_ltc')

        # Deleting field 'Userprofile.bitfinex2btcchina_ltc'
        db.delete_column(u'btc_userprofile', 'bitfinex2btcchina_ltc')

        # Deleting field 'Userprofile.btcchina2bitfinex_ltc'
        db.delete_column(u'btc_userprofile', 'btcchina2bitfinex_ltc')
    ...
    models = {
        ...
        u'btc.btcexchange': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 27, 0, 0)', 'blank': 'True'}),
