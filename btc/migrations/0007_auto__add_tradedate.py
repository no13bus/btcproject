...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tradedate'
        db.create_table(u'btc_tradedate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mtime', self.gf('django.db.models.fields.CharField')(default='', max_length=20)),
            ...
            ('mtype', self.gf('django.db.models.fields.CharField')(default='', max_length=20)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 9, 0, 0), blank=True)),
        ))
        db.send_create_signal(u'btc', ['Tradedate'])


    def backwards(self, orm):
        # Deleting model 'Tradedate'
        db.delete_table(u'btc_tradedate')
