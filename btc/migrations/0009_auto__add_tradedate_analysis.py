...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tradedate_analysis'
        db.create_table(u'btc_tradedate_analysis', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('buyorsell', self.gf('django.db.models.fields.CharField')(default='', max_length=20)),
            ('avg_price', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('start_time', self.gf('django.db.models.fields.CharField')(default='', max_length=20)),
            ('end_time', self.gf('django.db.models.fields.CharField')(default='', max_length=20)),
            ('buy_amount', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('sell_amount', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 10, 0, 0), blank=True)),
        ))
        db.send_create_signal(u'btc', ['Tradedate_analysis'])


    def backwards(self, orm):
        # Deleting model 'Tradedate_analysis'
        db.delete_table(u'btc_tradedate_analysis')
    ...
    models = {
        ...
        u'btc.btcexchange': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 10, 0, 0)', 'blank': 'True'}),
        ...
        u'btc.tradedate_analysis': {
            'Meta': {'object_name': 'Tradedate_analysis'},
            'avg_price': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'buy_amount': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'buyorsell': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 10, 0, 0)', 'blank': 'True'}),
            'end_time': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sell_amount': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'start_time': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20'})
        },
        u'btc.userprofile': {
